...
with open('/Users/sainandu/Downloads/MedicalDiagnosisSystem/api/model.json', 'r') as json_file:
    loaded_model_json = json_file.read()

loaded_model = model_from_json(loaded_model_json)
loaded_model.load_weights('/Users/sainandu/Downloads/MedicalDiagnisisSystem/api/model_weights.h5')
